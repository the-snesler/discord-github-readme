...
export const SVGCard: React.FC<SVGCardProps> = ({
  ...
  // note: on slow connections, this loads top-to-bottom! we want text/background elements near the top, and images near the bottom
  return (
    <svg
    ...
    >
      ...
      {/* displayables - high priority (this has username), render first */}
      ...
      {/* Banner - large, low priority */}
      <Banner options={options} banner={banner} />

      {/* Discord Icon must go on top of banner */}
      <path
        fill="#7778"
      ...
      {/* Avatar Decoration - large (animated), lowest priority */}
      {decoration && (
        <g>
